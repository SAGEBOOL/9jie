    ...
    if (!svg) {
        ...
        wrapper.innerHTML = `
            ...
            <div class="flex justify-center">
                <div class="w-full max-w-4xl" style="max-height: 500px; background: linear-gradient(145deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.06)); backdrop-filter: blur(20px) saturate(180%); -webkit-backdrop-filter: blur(20px) saturate(180%); border: 0.5px solid rgba(255, 255, 255, 0.18); border-radius: 32px; box-shadow: inset 0 1px 1px rgba(255, 255, 255, 0.15), inset 0 -1px 1px rgba(0, 0, 0, 0.1), 0 8px 32px rgba(0, 0, 0, 0.25); padding: 32px;">
